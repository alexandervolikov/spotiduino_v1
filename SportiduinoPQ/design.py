...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LogCard.setGeometry(QtCore.QRect(10, 230, 91, 31))
        ...
        self.ReadLog.setGeometry(QtCore.QRect(110, 230, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.line_5.setGeometry(QtCore.QRect(-3, 259, 211, 31))
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.FullLogCard = QtWidgets.QPushButton(self.tab_2)
        self.FullLogCard.setGeometry(QtCore.QRect(10, 320, 91, 31))
        self.FullLogCard.setObjectName("FullLogCard")
        self.ReadFullLog = QtWidgets.QPushButton(self.tab_2)
        self.ReadFullLog.setGeometry(QtCore.QRect(110, 320, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ReadFullLog.setFont(font)
        self.ReadFullLog.setObjectName("ReadFullLog")
        self.FullLogLine = QtWidgets.QLineEdit(self.tab_2)
        self.FullLogLine.setGeometry(QtCore.QRect(10, 280, 91, 31))
        self.FullLogLine.setObjectName("FullLogLine")
        ...
        self.AutoIncriment_log = QtWidgets.QCheckBox(self.tab_2)
        self.AutoIncriment_log.setGeometry(QtCore.QRect(120, 280, 81, 31))
        self.AutoIncriment_log.setObjectName("AutoIncriment_log")
        ...
        self.statusCard = QtWidgets.QPushButton(self.tab_3)
        self.statusCard.setGeometry(QtCore.QRect(110, 10, 91, 31))
        self.statusCard.setObjectName("statusCard")
        self.cleanCard = QtWidgets.QPushButton(self.tab_3)
        self.cleanCard.setGeometry(QtCore.QRect(10, 50, 91, 31))
        self.cleanCard.setObjectName("cleanCard")
        self.ntagPass1 = QtWidgets.QLineEdit(self.tab_3)
        self.ntagPass1.setGeometry(QtCore.QRect(10, 130, 41, 21))
        self.ntagPass1.setObjectName("ntagPass1")
        self.label_9 = QtWidgets.QLabel(self.tab_3)
        self.label_9.setGeometry(QtCore.QRect(50, 90, 131, 41))
        self.label_9.setObjectName("label_9")
        self.ntagPass2 = QtWidgets.QLineEdit(self.tab_3)
        self.ntagPass2.setGeometry(QtCore.QRect(60, 130, 41, 21))
        self.ntagPass2.setObjectName("ntagPass2")
        self.ntagPass3 = QtWidgets.QLineEdit(self.tab_3)
        self.ntagPass3.setGeometry(QtCore.QRect(110, 130, 41, 21))
        self.ntagPass3.setObjectName("ntagPass3")
        self.ntagPass4 = QtWidgets.QLineEdit(self.tab_3)
        self.ntagPass4.setGeometry(QtCore.QRect(160, 130, 41, 21))
        self.ntagPass4.setObjectName("ntagPass4")
        self.NtagPassCard = QtWidgets.QPushButton(self.tab_3)
        self.NtagPassCard.setGeometry(QtCore.QRect(10, 160, 191, 31))
        self.NtagPassCard.setObjectName("NtagPassCard")
        ...
        MainWindow.setTabOrder(self.ReadLog, self.PassCard)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FullLogCard.setText(_translate("MainWindow", "Full Dump"))
        self.ReadFullLog.setText(_translate("MainWindow", "Read Full"))
        self.AutoIncriment_st.setText(_translate("MainWindow", "Auto++"))
        self.AutoIncriment_log.setText(_translate("MainWindow", "Auto++"))
        ...
        self.statusCard.setText(_translate("MainWindow", "Status Card"))
        self.cleanCard.setText(_translate("MainWindow", "Clean Card"))
        self.label_9.setText(_translate("MainWindow", "Ntag password"))
        self.NtagPassCard.setText(_translate("MainWindow", "Ntag Pass Card"))
