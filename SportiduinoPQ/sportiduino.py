...
class Sportiduino(object):
    ...
    def init_state_card(self):
        self._send_command(Sportiduino.CMD_INIT_STATECARD,  wait_response=False)
    
    def init_clean_card(self):
        self._send_command(Sportiduino.CMD_INIT_CLEAN_CARD,  wait_response=False)
    ...
    def init_full_log_card(self, start_chip=0):
        ...
        @param start_chip: start chip number (default 0x0000)
        """
        params = b''
        params += Sportiduino._to_str(start_chip, 2)
        self._send_command(Sportiduino.CMD_INIT_FULL_LOG_CARD, params, wait_response=False)
